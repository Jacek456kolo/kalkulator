...
<html lang="en">
	...
	<div class="ramka"> 
		...
		<form action="" method="post">
			<input type="text" name="no1" id="no1" value="2" size="19px" style="text-align: right"><br>
			<input type="text" name="no2" id="no2" value="3" size="19px"><br>
			<br>
			...
			<input type="button" onclick="setIlorToInput()" name="button13" value="/"><br><br>
			...
			<input type="button" onclick="setIlocToInput()" name="button12" value="*"><br><br>
			...
			<input type="button" onclick="setWynToInput()" name="button14" value="=" style="width: 20px; height: 62px; position: fixed; top: 139px; left: 140px; margin-right: 10px"><br>
